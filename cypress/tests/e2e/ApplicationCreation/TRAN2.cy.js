...
import Eligibility from "../../../support/application/tran/tran2/Eligibility"

const program_code = 'TRAN2';

describe ('Tran2 Funding Process', function() {
    it ('Tran2 Funding opportunities', function() {
