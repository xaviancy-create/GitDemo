...
class FillPIDetails{
    ...
    completeSection(){
        ...
        this.clickSave();
        this.clickOrganizationalOfficialsandPayee();
    ...
    clickOrganizationalOfficialsandPayee(){
        cy.xpath("//a[text()='Organizational Officials and Payee']").click();
    }
