...
class FundingCalculator {
    ...
    completeSection() {
        ...
        cy.withSelected([
            ...
            { xpath: "(//input[@id='2_pi_co_pi_direct_costs_total'])", options: this.typeCost2},
            { xpath: "(//input[@id='1_pi_co_pi_excluded_equipment'])", options: this.typeCost2},
            { xpath: "(//input[@id='2_pi_co_pi_excluded_equipment'])", options: this.typeCost2},
            { xpath: "(//input[@id='1_pi_co_pi_excluded_trainees'])", options: this.typeCost2},
            { xpath: "(//input[@id='2_pi_co_pi_excluded_trainees'])", options: this.typeCost2},
