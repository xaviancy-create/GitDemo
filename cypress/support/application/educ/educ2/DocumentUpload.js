class DocumentUpload{
    ...
    completeSection() {
        ...
        cy.withSelected([
            { xpath: "//input[@type='file'][@data-test-id='doc_file_input_proposal_appendix']", options: this.pdfOptions },
            ...
            { xpath: "//input[@type='file'][@data-test-id='doc_file_input_graduate_outcomes_table']", options: this.excelOptions },
